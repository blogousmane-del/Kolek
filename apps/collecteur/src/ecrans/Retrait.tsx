          ...
          <>
            ...
            <div className="space-y-4 lg:grid lg:grid-cols-2 lg:gap-4 lg:space-y-0 lg:items-start">
              ...
              return (
                <Carte
                  key={carte.carteId}
                  className={`p-4 rounded-lg border border-hairline/80 shadow-xs hover:shadow-sm transition-all ${carte.cycleComplet ? 'border-positive/80 shadow-positive/5 ring-1 ring-positive/20' : ''} ${
