 ...
 * déclarée du produit — il n'existait aucun moyen d'atteindre Produit, Méthode,
 * Tarifs ou Accès autrement qu'en faisant défiler toute la page. Masquer une
 * navigation sans en offrir une autre n'est pas une adaptation à l'écran, c'est
 * une navigation absente.
 */
  ...
  return (
    ...
    // alors couvrir le titre de la carte défilant dessous.
      ...
      >
        ...
        {/* Le dépliant. Il ne remplace pas les liens : il les rend atteignables là
            où ils ne tiennent pas. Au-dessus de `md`, les liens sont visibles et
      ...
      {/* Le voile. Sans lui, toucher à côté du panneau ne le referme pas — et
          c'est le premier geste de quelqu'un qui a changé d'avis. */}
      {deplie && (
        <button
          type="button"
          aria-hidden
