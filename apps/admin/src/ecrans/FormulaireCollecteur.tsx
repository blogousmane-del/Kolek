      ...
      <div className="mt-4">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 min-w-0 bg-surface border border-hairline rounded-md px-3 py-2.5 font-mono text-champ text-ink focus:border-primary"
          />
          <Bouton
            variante="contour"
            icone="history"
  ...
  return (
    <div>
      ...
      <input
        ...
        className="w-full bg-surface border border-hairline rounded-md px-3 py-2.5 text-champ font-body text-ink focus:border-primary"
      />
    </div>
  );
}
